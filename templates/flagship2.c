...
core_hex_C, 2048, 
    ...
    {component_tri, // component 1
      ...
      {object_downlink, 256, 
        {component_tri, // component 2
          {object_uplink, 0},
          {object_move:auto_move, -1859},
          {object_move:auto_move, 1781},
        }
      },
      {object_downlink, 0, 
  ...
  {object_downlink, 256, 
    {component_fork, // component 6
      ...
      {object_interface, 0},
      {object_downlink, 0, 
        {component_long4, // component 7
          {object_uplink, 0},
          {object_interface, 0},
          {object_interface, 0},
          {object_move:auto_move, -1989},
        }
      },
    }
  },
  ...
  {object_downlink, 0, 
    {component_tri, // component 11
      {object_pulse_xl:auto_att_fwd, -1122},
      {object_pulse_xl:auto_att_left, 0},
      {object_uplink, 0},
    }
  },
  {object_downlink, 0, 
    {component_tri, // component 12
      {object_pulse_xl:auto_att_fwd, 1100},
      {object_uplink, 0},
      {object_pulse_xl:auto_att_right, 0},
    }
  }
