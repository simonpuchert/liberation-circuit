...
core_hex_B, 2048, 
  ...
  {object_downlink, -256, 
    {component_long5, // component 9
      {object_pulse_l:auto_att_fwd, 2048},
      {object_pulse_l:auto_att_fwd, -1855},
      {object_pulse_l:auto_att_fwd, -1160},
      {object_uplink, 0},
      {object_pulse_l:auto_att_fwd, 0},
    }
  },
  {object_downlink, 256, 
    {component_long5, // component 10
      {object_pulse_l:auto_att_fwd, -2048},
      {object_pulse_l:auto_att_fwd, 1001},
